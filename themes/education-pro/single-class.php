    ...
    <div class="row">	
        ...
        <div id="secondary" class="widget-area col-lg-4 col-md-6 col-sm-12" role="complementary">
            ...
            <div class="widget">
                ...
                <?php endif; ?>
                    ...
                    <div class="brochure-file">
                        <a class="btn-brochure" href="<?php echo esc_url($brochure_file); ?>" target="_blank"><i class="la la-file"></i> <?php esc_html_e('Download File', 'education-pro'); ?></a>
                    </div>
                    <?php endif; ?>
            ...
            if (is_active_sidebar('sidebar-classes')) : 
                dynamic_sidebar('sidebar-classes'); ?>
            <?php endif; ?>          
		</div> <!-- /#secondary -->
