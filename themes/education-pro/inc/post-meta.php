...
if (!function_exists('tx_comments')) :
  ...
  function tx_comments() {
    ...
    if ( ! comments_open() && get_comments_number() < 1 ) :
      comments_number( esc_html__( 'No Comments', 'education-pro' ), esc_html__( '1 Comment', 'education-pro' ), esc_html__( '% Comments', 'education-pro' ) );
    else :
      echo '<a href="' . esc_url( get_comments_link() ) . '">';
      comments_number( esc_html__( 'No Comment', 'education-pro' ), esc_html__( '1 Comment', 'education-pro' ), esc_html__( '% Comments', 'education-pro' ) );
      echo '</a>';
      endif;
          echo '</span>';
      }
    ...
    if ( ! comments_open() && get_comments_number() < 1 ) :
      ...
      echo '<a href="' . esc_url( get_comments_link() ) . '">';
      comments_number( esc_html__( 'Leave a Comment', 'education-pro' ), esc_html__( '1 Comment', 'education-pro' ), esc_html__( '% Comments', 'education-pro' ) );
      echo '</a>';
      endif;
          echo '</span>';
      }
    ...
    function tx_getPostViews($postID){
     ...
     // if ($tx['post-views']) :
        ...
        if($count==''){
            ...
            return '<span class="post-views"><i class="fa fa-eye"></i> 0 <span>' . esc_html__('View', 'education-pro') . '</span></span>';
        }
        return '<span class="post-views"><i class="fa fa-eye"></i> '.$count.' <span>' . esc_html__('Views', 'education-pro') . '</span></span>';
    //  endif;
    }
}
