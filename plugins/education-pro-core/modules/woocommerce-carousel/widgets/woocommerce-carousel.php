<?php
namespace EpElements\Modules\WoocommerceCarousel\Widgets;
...
class WoocommerceCarousel extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'EP Woocommerce Carousel', 'education-pro-core' );
    }
    ...
    if ( class_exists( 'WooCommerce' ) ) {
        ...
        $this->add_control(
            'number_of_posts',
            [
                'label' => esc_html__( 'Number of Products', 'education-pro-core' ),
...
<?php
            ...
            echo '<h4 class="text-align-center">' . esc_html__( 'Please install and activate WooCommerce plugin', 'education-pro-core' ) . '</h4>';
