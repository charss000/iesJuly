<?php
namespace EpElements\Modules\CoursesCarousel\Widgets;
...
class CoursesCarousel extends Widget_Base {
    ...
    public function get_name() {
        return 'ep-courses-carousel';
    }

    public function get_title() {
        return esc_html__( 'EP Courses Carousel', 'education-pro-core' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} ul.learn-press-courses .course' => 'background-color: {{VALUE}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .course-cateogory a' => 'color: {{VALUE}};',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .type-lp_course:hover .course-cateogory a' => 'color: {{VALUE}};',
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
              [
                   'name'    => 'cat_typography',
                   'selector'  => '{{WRAPPER}} .course-cateogory a',
              ]
        );
        $this->add_control(
            'price_sale_color',
        ...
        $this->add_control(
            'price_reg_color',
            [
                'label'     => esc_html__( 'Regular Price Color', 'education-pro-core' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
