<?php
namespace EpElements\Modules\PostTiled\Widgets;
...
class PostTiled extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'EP Post Tiled', 'education-pro-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options'           => [
                   'layout-1'       => esc_html__( 'Layout 1', 'education-pro-core' ),
                   'layout-2'       => esc_html__( 'Layout 2', 'education-pro-core' ),
                   'layout-3'       => esc_html__( 'Layout 3', 'education-pro-core' ),
                   'layout-4'       => esc_html__( 'Layout 4', 'education-pro-core' ),
                   'layout-5'       => esc_html__( 'Layout 5', 'education-pro-core' ),
                   'layout-6'       => esc_html__( 'Layout 6', 'education-pro-core' ),
                   'layout-7'       => esc_html__( 'Layout 7', 'education-pro-core' ),
                   'layout-8'       => esc_html__( 'Layout 8', 'education-pro-core' ),
                   'layout-9'       => esc_html__( 'Layout 9', 'education-pro-core' ),
                   'layout-10'      => esc_html__( 'Layout 10', 'education-pro-core' ),
                   'layout-11'      => esc_html__( 'Layout 11', 'education-pro-core' ),
                   'layout-12'      => esc_html__( 'Layout 12', 'education-pro-core' ),
                   'layout-13'      => esc_html__( 'Layout 13', 'education-pro-core' ),
                ],
                'default'           => 'layout-13',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Category BG Hover Color', 'education-pro-core' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'category_color',
            [
                'label'     => esc_html__( 'Category Font Color', 'education-pro-core' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'category_hov_color',
            [
                'label'     => esc_html__( 'Category Font Hover Color', 'education-pro-core' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        <div <?php echo $this->get_render_attribute_string( 'post-tiled' ); ?>>
            ...
            <?php if ($pt_query->have_posts()) : while ($pt_query->have_posts()) : $pt_query->the_post(); ?>
                ...
                <div class="post-tiled-block post-tiled-block-<?php echo intval( $position ); ?>">
                    ...
                    <div class="post-tiled-block-bg" <?php echo 'style="background-image:url('.esc_url( $thumb_url ).')"'; ?>>
            ...
            <?php
                    ...
                    if ( $layout == 'layout-4' || $layout == 'layout-12' ) {
