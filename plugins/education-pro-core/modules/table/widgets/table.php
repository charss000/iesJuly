<?php
namespace EpElements\Modules\Table\Widgets;
...
class Table extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'EP Table', 'education-pro-core' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'sec_table_header',
            [
                'label' => esc_html__( 'Header', 'education-pro-core' )
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'fields' => [
                    [
                        'name' => 'tx_table_header_col',
                        'label' => esc_html__( 'Title', 'education-pro-core' ),
                        'default' => 'Table Header',
                        'type' => Controls_Manager::TEXT,
                    ],
                    [
                        'name' => 'tx_table_header_col_span',
                        'label' => esc_html__( 'Span', 'education-pro-core' ),
                        'default' => '',
                        'type' => Controls_Manager::NUMBER,
                    ],
                    [
                        'name' => 'tx_table_header_col_icon_enabled',
                        'label' => esc_html__( 'Header Icon', 'education-pro-core' ),
                    ...
                    [
                        'name'  => 'tx_table_header_icon_type',
                        'label' => esc_html__( 'Icon Type', 'education-pro-core' ),
                    ...
                    [
                        'name' => 'tx_table_header_col_img_size',
        ...
        $this->start_controls_section(
            'sec_table_body',
            [
                'label' => esc_html__( 'Body', 'education-pro-core' )
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'fields' => [
                    [
                        'name' => 'tx_table_body_type',
                        'label' => esc_html__( 'Type', 'education-pro-core' ),
                        'type' => Controls_Manager::SELECT,
                        'default' => 'row',
                        'options' => [
                            'row' => esc_html__( 'Row', 'education-pro-core' ),
                            'col' => esc_html__( 'Column', 'education-pro-core' ),
                        ]
                    ],
                    [
                        'name'          => 'tx_table_body_colspan',
                        'label'         => esc_html__( 'Col Span', 'education-pro-core' ),
                        'type'          => Controls_Manager::NUMBER,
                        'default'       => 1,
                        'min'           => 1,
                        'label_block'   => true,
                    ...
                    [
                        'name'          => 'tx_table_body_rowspan',
                        'label'         => esc_html__( 'Row Span', 'education-pro-core' ),
                        'type'          => Controls_Manager::NUMBER,
                        'default'       => 1,
                        'min'           => 1,
                        'label_block'   => true,
                    ...
                    [
                        'name' => 'tx_table_body_content',
                        'type' => Controls_Manager::WYSIWYG,
                        'label_block' => true,
                        'default' => esc_html__( 'Content', 'education-pro-core' ),
                        'condition' => [
                            'tx_table_body_type' => 'col',
                        ]
                    ],
        ...
        $this->start_controls_section(
            'sec_styles',
            [
                'label' => esc_html__( 'General', 'education-pro-core' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Header Style', 'education-pro-core' ),
                'tab' => Controls_Manager::TAB_STYLE
            ]
        );
        ...
        $this->add_control(
            'table_header_radius',
            [
                'label' => esc_html__( 'Header Border Radius', 'education-pro-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 50,
        ...
        $this->start_controls_tabs('table_header_title_tabs');
            ...
            $this->start_controls_tab( 'table_header_title_normal', [ 'label' => esc_html__( 'Normal', 'education-pro-core' ) ] );
            ...
            $this->start_controls_tab( 'table_header_title_hover', [ 'label' => esc_html__( 'Hover', 'education-pro-core' ) ] );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Title Alignment', 'education-pro-core' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => true,
                'options' => [
                    'left' => [
        ...
        $this->start_controls_section(
            'sec_body_styles',
            [
                'label' => esc_html__( 'Body Style', 'education-pro-core' ),
                'tab' => Controls_Manager::TAB_STYLE
            ]
        );
        ...
        $this->start_controls_tabs('table_body_tabs');
            ...
            $this->start_controls_tab('table_body_normal', ['label' => esc_html__( 'Normal', 'education-pro-core')]);

                $this->add_control(
                    'table_content_color_odd',
                    [
                        'label' => esc_html__( 'Odd Row Color', 'education-pro-core' ),
                        'type' => Controls_Manager::COLOR,
                        'selectors' => [
                ...
                $this->add_control(
                    ...
                    [
                        'label' => esc_html__( 'Odd Row Background Color', 'education-pro-core' ),
                        'type' => Controls_Manager::COLOR,
                        'selectors' => [
                ...
                $this->add_control(
                    ...
                    [
                        'label' => esc_html__( 'Even Row Color', 'education-pro-core' ),
                        'type' => Controls_Manager::COLOR,
                        'separator' => 'before',
                        'selectors' => [
                ...
                $this->add_control(
                    ...
                    [
                        'label' => esc_html__( 'Even Row Background Color', 'education-pro-core' ),
                        'type' => Controls_Manager::COLOR,
                        'selectors' => [
            ...
            $this->start_controls_tab('table_body_odd_cell_hover_style', ['label' => esc_html__( 'Hover', 'education-pro-core')]);
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Content Alignment', 'education-pro-core' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => true,
                'options' => [
                    'left' => [
                ...
                <thead>
                    <tr class="table-header">
                        ...
                        <th <?php echo $this->get_render_attribute_string('th_class'.$i); ?>>
                            ...
                            ?><img <?php echo $this->get_render_attribute_string('data_table_th_img'.$i); ?>><?php endif; ?><?php echo __( $header_title['tx_table_header_col'], 'education-pro-core' ); ?></th>
                        <?php $i++; endforeach; ?>
                    </tr>
                </thead>
                <tbody>
                                    ...
                                    if( $table_tr[$i]['id'] == $table_td[$j]['row_id'] ) {
                                        ...
                                        ?>
                                            <td <?php echo $this->get_render_attribute_string('table_inside_td'.$i.$j); ?>>
                                                <div class="td-content-wrapper"><div <?php echo $this->get_render_attribute_string('td_content'); ?>><?php echo $table_td[$j]['content']; ?></div></div>
                                            </td>
