<?php
namespace EpElements\Modules\PostList\Widgets;
...
class PostList extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'EP Post List', 'education-pro-core' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::NUMBER,
                'default' => '50',
                'description' => esc_html__( 'This will not work for the first post of Style 1, Style 2 and Style 4.', 'education-pro-core' ),
                'condition' => [
                    'title' => 'show',
                ]
        ...
        $this->add_control(
            'title_color',
            [
                'label'     => esc_html__( 'Title Color First Post', 'education-pro-core' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'title_color_hover',
            [
                'label'     => esc_html__( 'Title First Post Hover Color', 'education-pro-core' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'title_color_last',
            [
                'label'     => esc_html__( 'Title Color Rest Posts', 'education-pro-core' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Title Rest Posts Hover Color', 'education-pro-core' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
