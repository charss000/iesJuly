<?php
namespace EpElements\Modules\ContactFormSeven\Widgets;
...
class ContactFormSeven extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'EP Contact Form 7', 'education-pro-core' );
    }
	...
	protected function register_controls() {
        ...
        if (!function_exists('wpcf7')) {
            $this->start_controls_section(
                'tx_notice',
                [
                    'label' => esc_html__('Notice', 'education-pro-core'),
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'raw' => __('Please install / activate <strong>Contact Form 7</strong> plugin.', 'education-pro-core'),
                ]
            );
        ...
        $this->add_control(
            'tx_cf7_list',
            [
                'label'                 => esc_html__( 'Select Form', 'education-pro-core' ),
        ...
        $this->start_controls_section(
            'tx_cf7__input',
            [
                'label' => esc_html__( 'Input', 'education-pro-core' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            'tx_cf7_input_height',
            [
                'label' => esc_html__( 'Input Field Height', 'education-pro-core' ),
                ...
                'selectors' => [
                    '{{WRAPPER}} .wpcf7-form .wpcf7-form-control-wrap .wpcf7-select, {{WRAPPER}} input.wpcf7-form-control.wpcf7-date.wpcf7-validates-as-date, {{WRAPPER}} input.wpcf7-form-control.wpcf7-text' => 'height: {{SIZE}}{{UNIT}};',
                ],
        ...
        $this->add_responsive_control(
            'tx_cf7_input_width',
            [
                'label' => esc_html__( 'Input Field Width', 'education-pro-core' ),
                'type' => Controls_Manager::SLIDER,
                ...
                'selectors' => [
                    '{{WRAPPER}} .wpcf7-form .wpcf7-form-control-wrap .wpcf7-select, {{WRAPPER}} input.wpcf7-form-control.wpcf7-date.wpcf7-validates-as-date, {{WRAPPER}} input.wpcf7-form-control.wpcf7-text' => 'width: {{SIZE}}{{UNIT}};',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Placeholder Color', 'education-pro-core' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Placeholder Typography', 'education-pro-core' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Input Text Color', 'education-pro-core' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Others Text Color', 'education-pro-core' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Input Typography', 'education-pro-core' ),
                'selector' => '{{WRAPPER}} .wpcf7-form-control.wpcf7-text, {{WRAPPER}} .wpcf7-form-control.wpcf7-textarea, {{WRAPPER}} .wpcf7-form-control.wpcf7-select',
            ]
        );
        $this->add_responsive_control(
            'tx_cf7_textarea_height',
            [
                'label' => esc_html__( 'Textarea Height', 'education-pro-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 125,
                ],
        ...
        $this->add_responsive_control(
            'tx_cf7_input_space',
            [
                'label' => esc_html__( 'Element Space', 'education-pro-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 25,
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Submit Button', 'education-pro-core' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    <?php
            ...
            <h4><?php echo esc_html__('Please install / activate Contact Form 7 plugin.', 'education-pro-core'); ?></h4>
