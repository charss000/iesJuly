...
esc_html__('- EP | Recent Posts', 'education-pro-core'), 
// Widget description
array( 'description' => esc_html__( 'Display recent/popular posts with thumbnail.', 'education-pro-core' ), ) 
);
...
$title = esc_html__( 'Recent posts', 'education-pro-core' );
}
...
<p>
<label for="<?php echo $this->get_field_id( 'post_type' ); ?>"><?php esc_html_e('Post Type', 'education-pro-core'); ?></label>
    <?php
...
<p>
<label for="<?php echo $this->get_field_id( 'orderby' ); ?>"><?php esc_html_e('Order By (Popular Posts will not work for custom post type)', 'education-pro-core'); ?></label>
    <?php
        $options = array(
...
<p>
			...
			<select id="<?php print $this->get_field_id('categories'); ?>" name="<?php print $this->get_field_name('categories'); ?>" class="widefat categories" style="width:100%;">
				<option value='all' <?php if ('all' == $instance['categories']) echo 'selected="selected"'; ?>><?php esc_html_e('All categories','education-pro-core'); ?></option>
...
<p>
			...
			<label for="<?php echo $this->get_field_name( 'show_views' ); ?>"><?php esc_html_e( 'Display post views (Will not work for custom post type)','education-pro-core' ); ?></label>
</p>
<p>
