...
class tx_Tags_Widget extends WP_Widget {
	...
	function __construct() {
		...
		esc_html__('- EP | Tags', 'education-pro-core'), 
		// Widget description
		array( 'description' => esc_html__( 'A cloud of your most used tags.', 'education-pro-core' ), ) 
		);
	}
	...
	public function form( $instance ) {
		...
		echo '<p><label for="' . $title_id . '">' . esc_html_e( 'Title:', 'education-pro-core' ) . '</label>
		...
		switch ( count( $taxonomies ) ) {
			...
			case 0:
				echo '<p>' . esc_html_e( 'The tag cloud will not be displayed since there are no taxonomies that support the tag cloud widget.', 'education-pro-core' ) . '</p>';
				printf( $input, '' );
				break;
			...
			default:
				printf(
					...
					$id,
					esc_html_e( 'Taxonomy:', 'education-pro-core' ),
					$name
				);
