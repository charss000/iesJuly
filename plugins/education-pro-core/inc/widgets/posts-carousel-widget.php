...
class tx_posts_carousel_widget extends WP_Widget {
    function __construct() {
        ...
        esc_html__('- EP | Posts Carousel', 'education-pro-core'), 
        // Widget description
        array( 'description' => esc_html__( 'Posts Carousel.', 'education-pro-core' ), ) 
        );
...
$title = esc_html__( 'Posts Carousel', 'education-pro-core' );
}
...
<p>
<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title', 'education-pro-core' ); ?></label> 
<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
</p>

<p>
<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php esc_html_e( 'Number of posts to show:', 'education-pro-core' ); ?></label>
<input class="tiny-text" id="<?php echo $this->get_field_id( 'number' ); ?>" name="<?php echo $this->get_field_name( 'number' ); ?>" type="number" step="1" min="1" value="<?php echo $number; ?>" size="3" />
</p>
<p>
<label for="<?php echo $this->get_field_id( 'title_lenth' ); ?>"><?php esc_html_e( 'Title Length', 'education-pro-core' ); ?></label>
...
<p>
<label for="<?php echo $this->get_field_id( 'column' ); ?>"><?php esc_html_e( 'Column', 'education-pro-core' ); ?></label>
...
<p>
<label for="<?php echo $this->get_field_id( 'orderby' ); ?>"><?php esc_html_e('Order By', 'education-pro-core'); ?></label>
    <?php
        $options = array(
...
<p>
			<label for="<?php print $this->get_field_id('categories'); ?>"><?php esc_html_e('Filter by Categories', 'education-pro-core'); ?></label>
...
<p>
            <label for="<?php echo $this->get_field_id( 'post_cat_color' ); ?>"><?php esc_html_e( 'Category color', 'education-pro-core' ); ?></label>
...
<p>
            <label for="<?php echo $this->get_field_id( 'post_title_color' ); ?>"><?php esc_html_e( 'Title color', 'education-pro-core' ); ?></label>
...
<p>
            <label for="<?php echo $this->get_field_id( 'post_title_hover_color' ); ?>"><?php esc_html_e( 'Title hover color', 'education-pro-core' ); ?></label>
...
<p>
            <label for="<?php echo $this->get_field_id( 'post_meta_color' ); ?>"><?php esc_html_e( 'Post Meta Color', 'education-pro-core' ); ?></label>
...
<p>
			...
			<label for="<?php echo $this->get_field_name( 'show_date' ); ?>"><?php esc_html_e( 'Display post date','education-pro-core' ); ?></label>
</p>
<p>
			...
			<label for="<?php echo $this->get_field_name( 'show_views' ); ?>"><?php esc_html_e( 'Display post views','education-pro-core' ); ?></label>
</p>
