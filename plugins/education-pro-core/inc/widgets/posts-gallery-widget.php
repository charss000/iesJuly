...
esc_html__('- EP | Posts Gallery', 'education-pro-core'), 
// Widget description
array( 'description' => esc_html__( 'Display posts thumbnail gallery.', 'education-pro-core' ), ) 
);
}
...
$title = esc_html__( 'Posts Gallery', 'education-pro-core' );
}
...
<p><label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php esc_html_e( 'Number of project to show:', 'education-pro-core' ); ?></label>
