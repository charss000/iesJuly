 ...
 */
  ...
  function tx_gallery_meta_callback($post) {
    ...
    <table class="form-table">
      <tr><td>
        <a class="gallery-add button" href="#" data-uploader-title="Add image(s) to gallery" data-uploader-button-text="Add image(s)"><?php esc_html_e('Add image','education-pro-core'); ?></a>
        ...
        <?php if ($ids) : foreach ($ids as $key => $value) : $image = wp_get_attachment_image_src($value); ?>
          <li>
            ...
            <a class="change-image button button-small" href="#" data-uploader-title="Change" data-uploader-button-text="Change"><?php esc_html_e('Change', 'education-pro-core'); ?></a><br>
            <small><a class="remove-image" href="#"><?php esc_html_e('Remove', 'education-pro-core'); ?></a></small>
          </li>
